...
Last updated: 2026-04-09 (America/Los_Angeles)
...
### Official CSV / HTML + GSI Geocoder
- Used for official municipal protected-tree registries that publish structured rows but omit stable point coordinates on some or all records.
- Recent examples: `Chikuma`, `Ebetsu`, `Hadano`, `Inagi`, `Iwaki`, `Kodaira`, and `Kunitachi`.
- Metadata comes from the official municipal dataset page or the published CSV itself.
- Geometry uses official lon/lat fields when available; otherwise the ETL sends the published municipal address string to Japan's official GSI `AddressSearch` endpoint and then clips the result to the official municipal boundary.
- Protected-tree ownership labels are preserved when the official source exposes them; unlabeled rows stay `unknown`.
...
|---|---|---|---|---|
| Adachi Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `足立区`, then clipped to the official MLIT 2024 administrative boundary for Adachi Ward |
| Arakawa Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `荒川区`, then clipped to the official MLIT 2024 administrative boundary for Arakawa Ward |
| Bunkyo Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `文京区`, then clipped to the official MLIT 2024 administrative boundary for Bunkyo Ward |
| Chiyoda Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `千代田区`, then clipped to the official MLIT 2024 administrative boundary for Chiyoda Ward |
| Chuo Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `中央区`, then clipped to the official MLIT 2024 administrative boundary for Chuo Ward |
| Edogawa Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `江戸川区`, then clipped to the official MLIT 2024 administrative boundary for Edogawa Ward |
| Kita Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `北区`, then clipped to the official MLIT 2024 administrative boundary for Kita Ward |
| Koto Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `江東区`, then clipped to the official MLIT 2024 administrative boundary for Koto Ward |
| Nakano Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `中野区`, then clipped to the official MLIT 2024 administrative boundary for Nakano Ward |
| Nerima Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `練馬区`, then clipped to the official MLIT 2024 administrative boundary for Nerima Ward |
| Ota Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `大田区`, then clipped to the official MLIT 2024 administrative boundary for Ota Ward |
| Setagaya Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `世田谷区`, then clipped to the official MLIT 2024 administrative boundary for Setagaya Ward |
| Shibuya Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `渋谷区`, then clipped to the official MLIT 2024 administrative boundary for Shibuya Ward |
| Shinagawa Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `品川区`, then clipped to the official MLIT 2024 administrative boundary for Shinagawa Ward |
| Shinjuku Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `新宿区`, then clipped to the official MLIT 2024 administrative boundary for Shinjuku Ward |
| Suginami Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `杉並区`, then clipped to the official MLIT 2024 administrative boundary for Suginami Ward |
| Sumida Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `墨田区`, then clipped to the official MLIT 2024 administrative boundary for Sumida Ward |
| Taito Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `台東区`, then clipped to the official MLIT 2024 administrative boundary for Taito Ward |
| Toshima Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `豊島区`, then clipped to the official MLIT 2024 administrative boundary for Toshima Ward |
| Hino | Downloaded Shapefile | `樹種`, `所在地`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `保存樹木・生垣` point shapefile filtered to `日野市`, then clipped to the official MLIT 2024 administrative boundary for Hino |
| Inagi | Official CSV / HTML + GSI Geocoder | `樹種名`, `所在地_連結表記`, official lon/lat columns when present | direct official coordinates when published, otherwise official GSI `AddressSearch` geocoding -> official MLIT boundary clipping | Official Inagi protected-tree CSV from Tokyo Open Data; rows without point coordinates fall back to the official Japanese national geocoder before clipping |
| Itabashi Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `板橋区`, then clipped to the official MLIT 2024 administrative boundary for Itabashi Ward |
| Kodaira | Official CSV / HTML + GSI Geocoder | `樹種`, `住所` | official GSI `AddressSearch` geocoding from the published municipal address -> official MLIT boundary clipping | Official Kodaira protected-tree CSV from Tokyo Open Data; structured address rows are geocoded through the official GSI endpoint and clipped to Kodaira |
| Kunitachi | Official CSV / HTML + GSI Geocoder | `樹種`, `住所` | official GSI `AddressSearch` geocoding from the published municipal address -> official MLIT boundary clipping | Official Kunitachi protected-tree CSV from Tokyo Open Data; chome-level protected-tree addresses are geocoded through the official GSI endpoint before clipping |
| Katsushika Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `葛飾区`, then clipped to the official MLIT 2024 administrative boundary for Katsushika Ward |
| Meguro Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `目黒区`, then clipped to the official MLIT 2024 administrative boundary for Meguro Ward |
| Minato Ward | Downloaded Shapefile | `樹種`, `整理番号`, `区市町村` | official Tokyo projected point shapefile -> JGD2011 Zone 9 inverse projection -> official MLIT boundary clipping | Official Tokyo Metropolitan Government `Street Trees / 街路樹` point shapefile filtered to `港区`, then clipped to the official MLIT 2024 administrative boundary for Minato Ward |
| Ebetsu | Official CSV / HTML + GSI Geocoder | municipal protected-tree HTML table fields such as `樹種` and `所在地` | official GSI `AddressSearch` geocoding from the published municipal address -> official boundary clipping | Official City of Ebetsu protected-tree table parsed from the public environment page and clipped to the official Ebetsu boundary |
| Iwaki | Official CSV / HTML + GSI Geocoder | municipal protected-tree HTML table fields such as `樹種` and `所在地` | official GSI `AddressSearch` geocoding from the published municipal address -> official boundary clipping | Official Iwaki City green-information table parsed from the public parks page and clipped to the official Iwaki boundary |
| Hadano | Official CSV / HTML + GSI Geocoder | `樹種`, `所在地` | official GSI `AddressSearch` geocoding from the published municipal address -> official boundary clipping | Official City of Hadano protected-tree CSV geocoded through the official GSI endpoint before clipping to Hadano |
| Chikuma | Official CSV / HTML + GSI Geocoder | municipal protected-tree HTML table fields such as `樹種` and `所在地` | official GSI `AddressSearch` geocoding from the published municipal address -> official boundary clipping | Official City of Chikuma protected-tree table parsed from the public environment page and clipped to the official Chikuma boundary |
...
| Oak Harbor | ArcGIS FeatureServer | `species` | ArcGIS point geometry | Official City of Oak Harbor public `Tree Inventory` layer clipped to the official jurisdiction boundary |
| Olympia | ArcGIS FeatureServer | `species` | ArcGIS point geometry | Official Washington State Capitol Campus urban-forest inventory clipped to the official Olympia boundary |
| Pullman | ArcGIS FeatureServer | `Genus` + `Species`, `CommonName`, `Removed` | ArcGIS point geometry | Official Washington State University public campus tree inventory clipped to the official Pullman boundary; rows exclude `Removed = 'Yes'` |
| Beaverton | ArcGIS FeatureServer | `BOTNAME`, `TREEDESCRIP`, `TREESTATUS` | ArcGIS point geometry | Official City of Beaverton `Street of Trees` layer; rows are restricted to `TREESTATUS = 'Existing'` before blossom classification and boundary clipping |
| Keizer | ArcGIS FeatureServer | `scientific`, `species` | ArcGIS point geometry | Official City of Keizer public tree inventory layer clipped to the official jurisdiction boundary |
| Tualatin | ArcGIS FeatureServer | `GENUS`, `SPECIES`, `TREE_REMOVED` | ArcGIS point geometry | Official City of Tualatin `Street Trees View`; rows exclude removed trees before blossom classification and boundary clipping |
| West Linn | ArcGIS FeatureServer | coded `GENUS`, coded `COMMONNAME` | ArcGIS point geometry with ArcGIS field-domain decoding | Official City of West Linn public street-tree inventory; coded-value domains are decoded before blossom classification and boundary clipping |
| Albany | TreePlotter API | public `species` lookup table + `trees.species_*` ids | TreePlotter EWKB point geometry converted from Web Mercator | Official Oregon Department of Forestry statewide public TreePlotter inventory clipped to the official Albany boundary; the cached statewide load resolves species names through the public `species` table before blossom classification |
| Salem | TreePlotter API | public `species` lookup table + `trees.species_*` ids | TreePlotter EWKB point geometry converted from Web Mercator | Official Oregon Department of Forestry statewide public TreePlotter inventory clipped to the official Salem boundary; the cached statewide load resolves species names through the public `species` table before blossom classification |
| Wilsonville | TreePlotter API | public `species` lookup table + `trees.species_*` ids | TreePlotter EWKB point geometry converted from Web Mercator | Official Oregon Department of Forestry statewide public TreePlotter inventory clipped to the official Wilsonville boundary; the cached statewide load resolves species names through the public `species` table before blossom classification |
| Grants Pass | TreePlotter API | public `species` lookup table + `trees.species_*` ids | TreePlotter EWKB point geometry converted from Web Mercator | Official Oregon Department of Forestry statewide public TreePlotter inventory clipped to the official Grants Pass boundary; the cached statewide load resolves species names through the public `species` table before blossom classification |
| Springfield | TreePlotter API | public `species` lookup table + `trees.species_*` ids | TreePlotter EWKB point geometry converted from Web Mercator | Official Oregon Department of Forestry statewide public TreePlotter inventory clipped to the official Springfield boundary; the cached statewide load resolves species names through the public `species` table before blossom classification |
| Redmond | TreePlotter API | public `species` lookup table + `trees.species_*` ids | TreePlotter EWKB point geometry converted from Web Mercator | Official Oregon Department of Forestry statewide public TreePlotter inventory clipped to the official Redmond boundary; the cached statewide load resolves species names through the public `species` table before blossom classification |
| Oregon City | TreePlotter API | public `species` lookup table + `trees.species_*` ids | TreePlotter EWKB point geometry converted from Web Mercator | Official Oregon Department of Forestry statewide public TreePlotter inventory clipped to the official Oregon City boundary; the cached statewide load resolves species names through the public `species` table before blossom classification |
| Forest Grove | TreePlotter API | public `species` lookup table + `trees.species_*` ids | TreePlotter EWKB point geometry converted from Web Mercator | Official Oregon Department of Forestry statewide public TreePlotter inventory clipped to the official Forest Grove boundary; the cached statewide load resolves species names through the public `species` table before blossom classification |
| Happy Valley | TreePlotter API | public `species` lookup table + `trees.species_*` ids | TreePlotter EWKB point geometry converted from Web Mercator | Official Oregon Department of Forestry statewide public TreePlotter inventory clipped to the official Happy Valley boundary; the cached statewide load resolves species names through the public `species` table before blossom classification |
| Lake Oswego | TreePlotter API | public `species` lookup table + `trees.species_*` ids | TreePlotter EWKB point geometry converted from Web Mercator | Official Oregon Department of Forestry statewide public TreePlotter inventory clipped to the official Lake Oswego boundary; the cached statewide load resolves species names through the public `species` table before blossom classification |
| Palm Springs | ArcGIS FeatureServer | `BOTANICAL`, `COMMON` | ArcGIS point geometry | Official City of Palm Springs public `Tree Inventory 2015` layer clipped to the official jurisdiction boundary |
| Turlock | ArcGIS FeatureServer | `scientific_name`, `common_name` | ArcGIS point geometry | Official California State University, Stanislaus public Crane Park tree inventory clipped to the official Turlock boundary |
| Watsonville | ArcGIS FeatureServer | `Scientific`, `CommonName`, `City` | ArcGIS point geometry | Official `Tree Inventories in Santa Clara County` shared ArcGIS service subset to `City = 'Watsonville'` before blossom classification |
...
| Boulder City | ArcGIS FeatureServer | `COMMON`, `BOTANICAL` | ArcGIS point geometry requested in `outSR=4326` | Official Nevada Division of Forestry `Clark County Schools Tree Inventory`; blossom rows are filtered server-side against `COMMON` / `BOTANICAL` and clipped to the official Boulder City boundary |
| Henderson | ArcGIS FeatureServer | `COMMON`, `BOTANICAL` | ArcGIS point geometry requested in `outSR=4326` | Official Nevada Division of Forestry `Clark County Schools Tree Inventory`; blossom rows are filtered server-side against `COMMON` / `BOTANICAL` and clipped to the official Henderson boundary |
| North Las Vegas | ArcGIS FeatureServer | `COMMON`, `BOTANICAL` | ArcGIS point geometry requested in `outSR=4326` | Official Nevada Division of Forestry `Clark County Schools Tree Inventory`; blossom rows are filtered server-side against `COMMON` / `BOTANICAL` and clipped to the official North Las Vegas boundary |
...
| Lehi | ArcGIS FeatureServer | `Species` common species name | ArcGIS point geometry | Official Utah Division of Forestry, Fire & State Lands `Utah Urban Tree Inventory` rows for the City of Lehi filtered by `Community = 'LEHI'` and clipped to the official jurisdiction boundary |
| Moab | ArcGIS FeatureServer | `Species` common species name | ArcGIS point geometry | Official Utah Division of Forestry, Fire & State Lands `Utah Urban Tree Inventory` rows for the City of Moab filtered by `Community = 'MOAB'` and clipped to the official jurisdiction boundary |
| Murray | ArcGIS FeatureServer | `Species` common species name | ArcGIS point geometry | Official Utah Division of Forestry, Fire & State Lands `Utah Urban Tree Inventory` rows for the City of Murray filtered by `Community = 'MURRAY'` and clipped to the official jurisdiction boundary |
| Nephi | ArcGIS FeatureServer | `Species` common species name | ArcGIS point geometry | Official Utah Division of Forestry, Fire & State Lands `Utah Urban Tree Inventory` rows for the City of Nephi filtered by `Community = 'NEPHI'` and clipped to the official jurisdiction boundary |
| Richfield | ArcGIS FeatureServer | `Species` common species name | ArcGIS point geometry | Official Utah Division of Forestry, Fire & State Lands `Utah Urban Tree Inventory` rows for the City of Richfield filtered by `Community = 'RICHFIELD'` and clipped to the official jurisdiction boundary |
| Riverton | ArcGIS FeatureServer | `Species` common species name | ArcGIS point geometry | Official Utah Division of Forestry, Fire & State Lands `Utah Urban Tree Inventory` rows for the City of Riverton filtered by `Community = 'RIVERTON'` and clipped to the official jurisdiction boundary |
| Sandy | ArcGIS FeatureServer | `Species` common species name | ArcGIS point geometry | Official Utah Division of Forestry, Fire & State Lands `Utah Urban Tree Inventory` rows for the City of Sandy filtered by `Community = 'SANDY' OR 'SANDY CITY'` and clipped to the official jurisdiction boundary |
| Santa Clara | ArcGIS FeatureServer | `Species` common species name | ArcGIS point geometry | Official Utah Division of Forestry, Fire & State Lands `Utah Urban Tree Inventory` rows for the City of Santa Clara filtered by `Community = 'SANTA CLARA'` and clipped to the official jurisdiction boundary |
| South Jordan | ArcGIS FeatureServer | `Species` common species name | ArcGIS point geometry | Official Utah Division of Forestry, Fire & State Lands `Utah Urban Tree Inventory` rows for the City of South Jordan filtered by `Community = 'SOUTH JORDAN'` and clipped to the official jurisdiction boundary |
| Taylorsville | ArcGIS FeatureServer | `Species` common species name | ArcGIS point geometry | Official Utah Division of Forestry, Fire & State Lands `Utah Urban Tree Inventory` rows for the City of Taylorsville filtered by `Community = 'TAYLORSVILLE'` and clipped to the official jurisdiction boundary |
| West Valley City | ArcGIS FeatureServer | `Species` common species name | ArcGIS point geometry | Official Utah Division of Forestry, Fire & State Lands `Utah Urban Tree Inventory` rows for West Valley City filtered by `Community = 'WEST VALLEY' OR 'WEST VALLEY CITY'` and clipped to the official jurisdiction boundary |

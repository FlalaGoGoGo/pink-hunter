...
MID_SOUTH_TREEKEEPER_CONFIGS: dict[str, dict[str, Any]] = {
    ...
    "Brentwood": {
        "base_url": "https://brentwoodmo.treekeepersoftware.com",
        "uid": "pinkhunter-brentwood-mo",
        "region": "mo",
        "source_department": "City of Brentwood",
        "note": "Integrated from the official City of Brentwood public TreeKeeper inventory.",
        "use_zip_index": False,
    },
    "Clarksville": {
        "base_url": "https://clarksvilletn.treekeepersoftware.com",
        "uid": "pinkhunter-clarksville-tn",
        "region": "tn",
        "source_department": "City of Clarksville",
        "note": "Integrated from the official City of Clarksville public TreeKeeper inventory.",
        "use_zip_index": False,
    },
    "Ferndale": {
        "base_url": "https://ferndalemi.treekeepersoftware.com",
        "uid": "pinkhunter-ferndale-mi",
        "region": "mi",
        "source_department": "City of Ferndale",
        "note": "Integrated from the official City of Ferndale public TreeKeeper inventory.",
        "use_zip_index": False,
    },
    "Kalamazoo": {
        "base_url": "https://kalamazoomi.treekeepersoftware.com",
        "uid": "pinkhunter-kalamazoo-mi",
        "region": "mi",
        "source_department": "City of Kalamazoo",
        "note": "Integrated from the official City of Kalamazoo public TreeKeeper inventory.",
        "use_zip_index": False,
    },
    "Madison": {
        "base_url": "https://madisonwi.treekeepersoftware.com",
        "uid": "pinkhunter-madison-wi",
        "region": "wi",
        "source_department": "City of Madison",
        "note": "Integrated from the official City of Madison public TreeKeeper inventory.",
        "use_zip_index": False,
    },
    "Springfield": {
        "base_url": "https://springfieldmo.treekeepersoftware.com",
        "uid": "pinkhunter-springfield-mo",
        "region": "mo",
        "source_department": "City of Springfield",
        "note": "Integrated from the official City of Springfield public TreeKeeper inventory.",
        "use_zip_index": False,
...
UNCOVERED_STATE_ARCGIS_CONFIGS: dict[str, dict[str, Any]] = {
    "Carmel": {
        "region": "in",
        "layer_url": "https://carmelgis.carmel.in.gov/arcserver/rest/services/CSD/CSD_Viewer/FeatureServer/312",
        "dataset_page": "https://www.carmel.in.gov/government/departments-services/community-services/urban-forestry",
        "where": "UPPER(COMM_NAME) LIKE '%CHERRY%' OR UPPER(COMM_NAME) LIKE '%PLUM%' OR UPPER(COMM_NAME) LIKE '%PEACH%' OR UPPER(COMM_NAME) LIKE '%MAGNOLIA%' OR UPPER(COMM_NAME) LIKE '%CRABAPPLE%' OR UPPER(COMM_NAME) LIKE '%APPLE%'",
        "object_id_field": "OBJECTID",
        "common_field": "COMM_NAME",
        "scientific_field": "SPP",
        "source_department": "City of Carmel",
        "ownership_raw": "City of Carmel",
        "note": "Integrated from the official City of Carmel public tree inventory ArcGIS layer and clipped to the official jurisdiction boundary.",
        "clip_to_boundary": True,
        "lon_field": "X",
        "lat_field": "Y",
    },
    "Maitland": {
        "region": "fl",
        "layer_url": "https://services8.arcgis.com/q4Vpy7r3KXnWcTBW/arcgis/rest/services/Tree_Inventory/FeatureServer/0",
        "dataset_page": "https://services8.arcgis.com/q4Vpy7r3KXnWcTBW/arcgis/rest/services/Tree_Inventory/FeatureServer/0",
        "where": "UPPER(COMMON) LIKE '%CHERRY%' OR UPPER(COMMON) LIKE '%PLUM%' OR UPPER(COMMON) LIKE '%PEACH%' OR UPPER(COMMON) LIKE '%MAGNOLIA%' OR UPPER(COMMON) LIKE '%CRABAPPLE%' OR UPPER(COMMON) LIKE '%APPLE%'",
        "object_id_field": "OBJECTID",
        "common_field": "COMMON",
        "scientific_field": "BOTANICAL",
        "source_department": "City of Maitland",
        "ownership_raw": "City of Maitland",
        "note": "Integrated from the official City of Maitland public tree inventory ArcGIS layer and clipped to the official jurisdiction boundary.",
        "clip_to_boundary": True,
        "lon_field": "X",
        "lat_field": "Y",
    },
    "Michigan City": {
        "region": "in",
        "layer_url": "https://services8.arcgis.com/01oq2N3cUfdKDUBU/arcgis/rest/services/GLUF_Michigan_City_Trees_for_Public_View_8_19_25/FeatureServer/0",
        "dataset_page": "https://www.arcgis.com/home/item.html?id=85b7a9bdcb904f77b6815680b7c166de",
        ...
        "source_department": "City of Michigan City",
        "ownership_raw": "City of Michigan City",
        "note": "Integrated from the official City of Michigan City public tree inventory ArcGIS layer and clipped to the official jurisdiction boundary.",
        "clip_to_boundary": True,
        "lon_field": "X",
        "lat_field": "Y",
    },
    "Westfield": {
        "region": "in",
        "layer_url": "https://maps.westfield.in.gov/arcgis/rest/services/Parks/TreeInventory/MapServer/0",
        "dataset_page": "https://maps.westfield.in.gov/arcgis/rest/services/Parks/TreeInventory/MapServer/0",
        "where": "UPPER(Tree) LIKE '%CHERRY%' OR UPPER(Tree) LIKE '%PLUM%' OR UPPER(Tree) LIKE '%PEACH%' OR UPPER(Tree) LIKE '%MAGNOLIA%' OR UPPER(Tree) LIKE '%CRABAPPLE%' OR UPPER(Tree) LIKE '%APPLE%'",
        "object_id_field": "OBJECTID",
        "common_field": "Tree",
        "source_department": "City of Westfield",
        "ownership_raw": "City of Westfield",
        "note": "Integrated from the official City of Westfield public tree inventory ArcGIS layer and clipped to the official jurisdiction boundary.",
        "clip_to_boundary": True,
    },
    "Cape Coral": {
        "region": "fl",
    ...
    "Aurora": {
        ...
        "layer_url": VAUGHAN_TREES_LAYER,
        "dataset_page": VAUGHAN_DATASET_PAGE,
        "where": "STATUS = 'Active' AND MUNICIPALITY = 'Aurora' AND (UPPER(SPECIES) LIKE 'PRUNUS%' OR UPPER(SPECIES) LIKE 'MALUS%' OR UPPER(SPECIES) LIKE 'MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CHERRY%' OR UPPER(COMMONNAME) LIKE '%PLUM%' OR UPPER(COMMONNAME) LIKE '%PEACH%' OR UPPER(COMMONNAME) LIKE '%MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CRABAPPLE%' OR UPPER(COMMONNAME) LIKE '%APPLE%')",
        "object_id_field": "OBJECTID",
        "common_field": "COMMONNAME",
        "scientific_field": "SPECIES",
        "source_name": "Street Trees",
        "source_department": "York Region",
        "ownership_raw": "York Region",
        "note": "Integrated from the official York Region street trees ArcGIS layer after restricting to active Aurora rows and clipping to the official Statistics Canada CSD boundary.",
        "clip_to_boundary": True,
    },
    "East Gwillimbury": {
        "region": "on",
        "layer_url": VAUGHAN_TREES_LAYER,
        "dataset_page": VAUGHAN_DATASET_PAGE,
        "where": "STATUS = 'Active' AND MUNICIPALITY = 'East Gwillimbury' AND (UPPER(SPECIES) LIKE 'PRUNUS%' OR UPPER(SPECIES) LIKE 'MALUS%' OR UPPER(SPECIES) LIKE 'MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CHERRY%' OR UPPER(COMMONNAME) LIKE '%PLUM%' OR UPPER(COMMONNAME) LIKE '%PEACH%' OR UPPER(COMMONNAME) LIKE '%MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CRABAPPLE%' OR UPPER(COMMONNAME) LIKE '%APPLE%')",
        "object_id_field": "OBJECTID",
        "common_field": "COMMONNAME",
        "scientific_field": "SPECIES",
        "source_name": "Street Trees",
        "source_department": "York Region",
        "ownership_raw": "York Region",
        "note": "Integrated from the official York Region street trees ArcGIS layer after restricting to active East Gwillimbury rows and clipping to the official Statistics Canada CSD boundary.",
        "clip_to_boundary": True,
    },
    "Georgina": {
        "region": "on",
        "layer_url": VAUGHAN_TREES_LAYER,
        "dataset_page": VAUGHAN_DATASET_PAGE,
        "where": "STATUS = 'Active' AND MUNICIPALITY = 'Georgina' AND (UPPER(SPECIES) LIKE 'PRUNUS%' OR UPPER(SPECIES) LIKE 'MALUS%' OR UPPER(SPECIES) LIKE 'MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CHERRY%' OR UPPER(COMMONNAME) LIKE '%PLUM%' OR UPPER(COMMONNAME) LIKE '%PEACH%' OR UPPER(COMMONNAME) LIKE '%MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CRABAPPLE%' OR UPPER(COMMONNAME) LIKE '%APPLE%')",
        "object_id_field": "OBJECTID",
        "common_field": "COMMONNAME",
        "scientific_field": "SPECIES",
        "source_name": "Street Trees",
        "source_department": "York Region",
        "ownership_raw": "York Region",
        "note": "Integrated from the official York Region street trees ArcGIS layer after restricting to active Georgina rows and clipping to the official Statistics Canada CSD boundary.",
        "clip_to_boundary": True,
    },
    "King": {
        "region": "on",
        "layer_url": VAUGHAN_TREES_LAYER,
        "dataset_page": VAUGHAN_DATASET_PAGE,
        "where": "STATUS = 'Active' AND MUNICIPALITY = 'King' AND (UPPER(SPECIES) LIKE 'PRUNUS%' OR UPPER(SPECIES) LIKE 'MALUS%' OR UPPER(SPECIES) LIKE 'MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CHERRY%' OR UPPER(COMMONNAME) LIKE '%PLUM%' OR UPPER(COMMONNAME) LIKE '%PEACH%' OR UPPER(COMMONNAME) LIKE '%MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CRABAPPLE%' OR UPPER(COMMONNAME) LIKE '%APPLE%')",
        "object_id_field": "OBJECTID",
        "common_field": "COMMONNAME",
        "scientific_field": "SPECIES",
        "source_name": "Street Trees",
        "source_department": "York Region",
        "ownership_raw": "York Region",
        "note": "Integrated from the official York Region street trees ArcGIS layer after restricting to active King rows and clipping to the official Statistics Canada CSD boundary.",
        "clip_to_boundary": True,
    },
    "Markham": {
        "region": "on",
        "layer_url": VAUGHAN_TREES_LAYER,
        "dataset_page": VAUGHAN_DATASET_PAGE,
        "where": "STATUS = 'Active' AND MUNICIPALITY = 'Markham' AND (UPPER(SPECIES) LIKE 'PRUNUS%' OR UPPER(SPECIES) LIKE 'MALUS%' OR UPPER(SPECIES) LIKE 'MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CHERRY%' OR UPPER(COMMONNAME) LIKE '%PLUM%' OR UPPER(COMMONNAME) LIKE '%PEACH%' OR UPPER(COMMONNAME) LIKE '%MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CRABAPPLE%' OR UPPER(COMMONNAME) LIKE '%APPLE%')",
        "object_id_field": "OBJECTID",
        "common_field": "COMMONNAME",
        "scientific_field": "SPECIES",
        "source_name": "Street Trees",
        "source_department": "York Region",
        "ownership_raw": "York Region",
        "note": "Integrated from the official York Region street trees ArcGIS layer after restricting to active Markham rows and clipping to the official Statistics Canada CSD boundary.",
        "clip_to_boundary": True,
    },
    "Newmarket": {
        "region": "on",
        "layer_url": VAUGHAN_TREES_LAYER,
        "dataset_page": VAUGHAN_DATASET_PAGE,
        "where": "STATUS = 'Active' AND MUNICIPALITY = 'Newmarket' AND (UPPER(SPECIES) LIKE 'PRUNUS%' OR UPPER(SPECIES) LIKE 'MALUS%' OR UPPER(SPECIES) LIKE 'MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CHERRY%' OR UPPER(COMMONNAME) LIKE '%PLUM%' OR UPPER(COMMONNAME) LIKE '%PEACH%' OR UPPER(COMMONNAME) LIKE '%MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CRABAPPLE%' OR UPPER(COMMONNAME) LIKE '%APPLE%')",
        "object_id_field": "OBJECTID",
        "common_field": "COMMONNAME",
        "scientific_field": "SPECIES",
        "source_name": "Street Trees",
        "source_department": "York Region",
        "ownership_raw": "York Region",
        "note": "Integrated from the official York Region street trees ArcGIS layer after restricting to active Newmarket rows and clipping to the official Statistics Canada CSD boundary.",
        "clip_to_boundary": True,
    },
    "Richmond Hill": {
        "region": "on",
        "layer_url": VAUGHAN_TREES_LAYER,
        "dataset_page": VAUGHAN_DATASET_PAGE,
        "where": "STATUS = 'Active' AND MUNICIPALITY = 'Richmond Hill' AND (UPPER(SPECIES) LIKE 'PRUNUS%' OR UPPER(SPECIES) LIKE 'MALUS%' OR UPPER(SPECIES) LIKE 'MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CHERRY%' OR UPPER(COMMONNAME) LIKE '%PLUM%' OR UPPER(COMMONNAME) LIKE '%PEACH%' OR UPPER(COMMONNAME) LIKE '%MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CRABAPPLE%' OR UPPER(COMMONNAME) LIKE '%APPLE%')",
        "object_id_field": "OBJECTID",
        "common_field": "COMMONNAME",
        "scientific_field": "SPECIES",
        "source_name": "Street Trees",
        "source_department": "York Region",
        "ownership_raw": "York Region",
        "note": "Integrated from the official York Region street trees ArcGIS layer after restricting to active Richmond Hill rows and clipping to the official Statistics Canada CSD boundary.",
        "clip_to_boundary": True,
    },
    "Whitchurch-Stouffville": {
        ...
        "layer_url": VAUGHAN_TREES_LAYER,
        "dataset_page": VAUGHAN_DATASET_PAGE,
        "where": "STATUS = 'Active' AND MUNICIPALITY = 'Whitchurch-Stouffville' AND (UPPER(SPECIES) LIKE 'PRUNUS%' OR UPPER(SPECIES) LIKE 'MALUS%' OR UPPER(SPECIES) LIKE 'MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CHERRY%' OR UPPER(COMMONNAME) LIKE '%PLUM%' OR UPPER(COMMONNAME) LIKE '%PEACH%' OR UPPER(COMMONNAME) LIKE '%MAGNOLIA%' OR UPPER(COMMONNAME) LIKE '%CRABAPPLE%' OR UPPER(COMMONNAME) LIKE '%APPLE%')",
        "object_id_field": "OBJECTID",
        "common_field": "COMMONNAME",
        "scientific_field": "SPECIES",
        "source_name": "Street Trees",
        "source_department": "York Region",
        "ownership_raw": "York Region",
        "note": "Integrated from the official York Region street trees ArcGIS layer after restricting to active Whitchurch-Stouffville rows and clipping to the official Statistics Canada CSD boundary.",
        "clip_to_boundary": True,
    },
    "Port Moody": {
        "region": "bc",
        "layer_url": "https://services5.arcgis.com/Q4JfC7BraThG8umv/ArcGIS/rest/services/Port_Moody_Planting_Plan_BASE/FeatureServer/1",
        "dataset_page": "https://services5.arcgis.com/Q4JfC7BraThG8umv/ArcGIS/rest/services/Port_Moody_Planting_Plan_BASE/FeatureServer/1",
        "where": "STATUS = 'OPERATIONAL' AND TYPE = 'Street Tree' AND (UPPER(SCIENTIFIC) LIKE 'PRUNUS%' OR UPPER(SCIENTIFIC) LIKE 'MALUS%' OR UPPER(SCIENTIFIC) LIKE 'MAGNOLIA%' OR UPPER(COMMON_NAM) LIKE '%CHERRY%' OR UPPER(COMMON_NAM) LIKE '%PLUM%' OR UPPER(COMMON_NAM) LIKE '%PEACH%' OR UPPER(COMMON_NAM) LIKE '%MAGNOLIA%' OR UPPER(COMMON_NAM) LIKE '%CRABAPPLE%' OR UPPER(COMMON_NAM) LIKE '%APPLE%')",
        "object_id_field": "FID",
        "common_field": "COMMON_NAM",
        "scientific_field": "SCIENTIFIC",
        "source_name": "Street Trees Inventory",
        "source_department": "City of Port Moody",
        "ownership_raw": "City of Port Moody",
        "note": "Integrated from the official City of Port Moody street-trees ArcGIS layer after restricting to operational street trees and clipping to the official jurisdiction boundary.",
        "clip_to_boundary": True,
    },
    "White Rock": {
        "region": "bc",
        "layer_url": "https://maps.whiterockcity.ca/server/rest/services/opendata/opendata_addintionalformats/MapServer/15",
        "dataset_page": "https://maps.whiterockcity.ca/opendata/download/preview.html?layername=Tree&filetype=shapefile%20target=",
        "where": "(Removed IS NULL OR Removed = 0) AND (UPPER(SpeciesNam) LIKE 'PRUNUS%' OR UPPER(SpeciesNam) LIKE 'MALUS%' OR UPPER(SpeciesNam) LIKE 'MAGNOLIA%' OR UPPER(CommName) LIKE '%CHERRY%' OR UPPER(CommName) LIKE '%PLUM%' OR UPPER(CommName) LIKE '%PEACH%' OR UPPER(CommName) LIKE '%MAGNOLIA%' OR UPPER(CommName) LIKE '%CRABAPPLE%' OR UPPER(CommName) LIKE '%APPLE%')",
        "object_id_field": "OBJECTID",
        "common_field": "CommName",
        "scientific_field": "SpeciesNam",
        "source_name": "Trees",
        "source_department": "City of White Rock Parks Department",
        "ownership_raw": "City of White Rock",
        "note": "Integrated from the official City of White Rock public tree map service after excluding removed trees and clipping to the official jurisdiction boundary.",
        "clip_to_boundary": True,
    },
    "Kingston": {
        "region": "on",

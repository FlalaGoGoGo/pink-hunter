...
JAPAN_PREFECTURE_META: dict[str, dict[str, Any]] = {
    "fukushima": {"label": "Fukushima", "code": "Fukushima"},
    "hokkaido": {"label": "Hokkaido", "code": "Hokkaido"},
    "kanagawa": {"label": "Kanagawa", "code": "Kanagawa"},
    "nagano": {"label": "Nagano", "code": "Nagano"},

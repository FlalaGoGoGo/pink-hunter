...
const copy = {
  "en-US": {
    ...
    showAllPanelTitle: "Show All",
    showAllPanelBody: "Show all covered trees in the current map view.",
    jumpTitle: "Jump",

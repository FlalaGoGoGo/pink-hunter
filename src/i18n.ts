...
const copy = {
  "en-US": {
    ...
    jumpTitle: "Jump",
    jumpBody: "Choose a country, state or province, and optionally a city or county, then jump to that area.",
    jumpCountry: "Country",
    jumpStateProvince: "State / Province",
    jumpArea: "City / County",
    jumpAnyStateProvince: "Any state / province",
    jumpAnyArea: "Any city / county",
    jumpButton: "Jump",
    ...
    searchCityPlaceholder: "Search city or county",
    cityBadge: "City",
    countyBadge: "County",
  ...
  "es-ES": {
    ...
    searchCityPlaceholder: "Buscar ciudad o condado",
    cityBadge: "Ciudad",
    countyBadge: "Condado",
  ...
  "ko-KR": {
    ...
    searchCityPlaceholder: "시 또는 카운티 검색",
    cityBadge: "도시",
    countyBadge: "카운티",
  ...
  "ja-JP": {
    ...
    searchCityPlaceholder: "市または郡を検索",
    cityBadge: "市",
    countyBadge: "郡",
  ...
  "fr-FR": {
    ...
    searchCityPlaceholder: "Rechercher une ville ou un comté",
    cityBadge: "Ville",
    countyBadge: "Comté",
  ...
  "vi-VN": {
    ...
    searchCityPlaceholder: "Tìm thành phố hoặc quận hạt",
    cityBadge: "Thành phố",
